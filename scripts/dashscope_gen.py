...
def gen(prompt, out_path, size="1664*928"):
    ...
    try:
        ...
        print("ERR: unexpected response:", json.dumps(data)[:400])
        return False
...
if __name__ == "__main__":
    ...
    if kind == "intro":
        prompt = (
            "Cinematic dark cyberpunk title card background for a DeFi security product, "
        ...
        prompt = (
            "Cinematic dark cyberpunk outro background, near-black deep navy #0a0e14, "
        ...
        gen(
            "A single glowing cyan cube on near-black background, minimal, no text",
            "/tmp/ds_test.png",
        )
