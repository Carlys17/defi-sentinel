...
req = urllib.request.Request(BASE + "/compatible-mode/v1/models",
...
try:
    ...
    media = [i for i in ids if any(s in i for s in
             ["image","wan","t2i","video","t2v"])]
...
payload = {"model": "qwen3.7-flash",
           ...
           "max_tokens": 8}
req = urllib.request.Request(BASE + "/compatible-mode/v1/chat/completions",
