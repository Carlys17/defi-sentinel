#!/bin/bash
# DeFi Sentinel v6 walkthrough — matches revised brief timing (~95s)
# Terminal: 140x40. All real commands, no mocks.
...
cat << 'EOF'
  Your DeFi portfolio never sleeps. Manual monitoring can't catch liquidations,
  MEV, and failed transactions in time.
